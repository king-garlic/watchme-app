...
const Movie = ({movie}) => {
  ...
  return (
    <div className="container max-w-4xl mx-auto pt-6">
        ...
        <div className="px-3">
            <Image alt="" src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} 
            ...
            <p className="mt-5 textgray600 text-sm">Genres: <span className="font-bold">{movie.genres.map(genre=>genre.name).join(',  ')}</span></p>
